              ...
              return (
                <SelectItem key={index} value={theme.name}>
                  <SelectPrimitive.SelectItemText>
                    {theme.id === THEMES.vercel.id ? (
                      <span className={styles.themePreview}>
                        <svg className={styles.logo} height="64" role="img" viewBox="0 0 74 64">
                          <path d="M37.5896 0.25L74.5396 64.25H0.639648L37.5896 0.25Z" fill="white"></path>
                        </svg>
                      </span>
                    ) : theme.id === THEMES.rabbit.id ? (
                      <span className={styles.themePreview}>
                        <svg width="251" height="264" viewBox="0 0 251 264" className={styles.logo}>
                          <path
                            fillRule="evenodd"
                            clipRule="evenodd"
                    ...
                    ) : theme.id === THEMES.supabase.id ? (
                      <span className={styles.themePreview}>
                        <svg width="109" height="113" viewBox="0 0 109 113" className={styles.logo}>
                          <path
