...
import { emitCodeAtom } from "@code/store/emit_code";
...
function EditorEmit() {
  ...
  const [emitCode, setEmitCode] = useAtom(emitCodeAtom);
  ...
  const numberOfLines = (emitCode.match(/\n/g) || []).length;
  ...
  return (
    ...
    >
      ...
      />
      <HighlightedCode code={emitCode} selectedLanguage={selectedLanguage} />
    </div>
  );
}

export default EditorEmit;
