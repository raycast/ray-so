...
export interface ComboboxTriggerProps
  extends
    Omit<React.ComponentPropsWithoutRef<typeof ComboboxPrimitive.Trigger>, "className">,
...
export interface ComboboxInputProps
  extends
    Omit<React.ComponentPropsWithoutRef<typeof ComboboxPrimitive.Input>, "className" | "size">,
...
export interface ComboboxInputContainerProps
  extends React.HTMLAttributes<HTMLDivElement>, VariantProps<typeof inputContainerVariants> {
  icon?: React.ElementType;
}
