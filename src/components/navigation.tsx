...
export function Navigation() {
  ...
  return (
    <nav className="flex items-center gap-3 h-[50px] pl-4 pr-5 w-full fixed z-10 border-b border-accent">
      <div
        className={cn(
      ...
      >
        <Button
          variant={"secondary"}
          className={cn(
            "rounded-full shadow-none w-6 h-6 bg-gray-4 hover:bg-gray-5 ",
        ...
        <DropdownMenu>
          <DropdownMenuTrigger asChild>
            <Button className="py-1 pl-1 pr-2 gap-2 data-[state=open]:bg-gray-4 ">
