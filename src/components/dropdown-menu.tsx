...
>(({ className, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.SubContent
      ref={ref}
      className={cn(
        `z-50 min-w-32 overflow-hidden rounded-md border border-gray-4 bg-panel p-1 shadow-lg 
...
>(({ className, sideOffset = 4, ...props }, ref) => (
  <DropdownMenuPrimitive.Portal>
    <DropdownMenuPrimitive.Content
      ...
      className={cn(
        `will-change-[opacity,transform] z-50 min-w-38 overflow-hidden rounded-md bg-panel border border-gray-4 p-1 shadow-md
